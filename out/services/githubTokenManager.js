...
exports.GitHubTokenManager = void 0;
...
class GitHubTokenManager {
    ...
    async getToken() {
        try {
            const configToken = vscode.workspace.getConfiguration('code-review').get('githubToken');
    ...
    async validateToken(token) {
        ...
        try {
            const response = await axios_1.default.get(`${GitHubTokenManager.GITHUB_API_URL}/user`, {
                headers: {
...
exports.GitHubTokenManager = GitHubTokenManager;
GitHubTokenManager.TOKEN_KEY = 'github.token';
GitHubTokenManager.GITHUB_API_URL = 'https://api.github.com';
GitHubTokenManager.TOKEN_VALIDATION_TIMEOUT = 5000; // 5 seconds
//# sourceMappingURL=githubTokenManager.js.map