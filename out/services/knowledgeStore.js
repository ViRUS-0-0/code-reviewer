...
class KnowledgeStore {
    constructor(workspaceRoot) {
        this.MAX_KNOWLEDGE_TOKENS = 1000;
        this.CHARS_PER_TOKEN = 4; // Rough approximation
        this.workspaceRoot = workspaceRoot;
    }
    async getKnowledge(activeFilePath) {
        let knowledge = '';
    ...
    async findRelevantSnippets(activeFilePath) {
