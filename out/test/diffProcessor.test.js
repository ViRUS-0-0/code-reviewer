...
+  console.log('Hello');
   return 'world';
            ...
            const files = diffProcessor_1.DiffProcessor.parseDiff(diff);
...
-export const c = 3;`;
        ...
        test('should handle empty diff', () => {
            const files = diffProcessor_1.DiffProcessor.parseDiff('');
    ...
    suite('detectTechStack', () => {
        test('should detect TypeScript', () => {
            ...
            const stack = diffProcessor_1.DiffProcessor.detectTechStack(files);
    ...
    suite('selectImportantFiles', () => {
        test('should select files by importance', () => {
            ...
            const selected = diffProcessor_1.DiffProcessor.selectImportantFiles(files, 2);
        ...
        test('should respect max files limit', () => {
            ...
            const selected = diffProcessor_1.DiffProcessor.selectImportantFiles(files, 5);
        ...
        test('should respect token budget', () => {
            ...
            const selected = diffProcessor_1.DiffProcessor.selectImportantFiles(files, 10, 1000);
    ...
    suite('generateChangeSummary', () => {
        test('should generate summary with correct totals', () => {
            ...
            const summary = diffProcessor_1.DiffProcessor.generateChangeSummary(files);
    ...
    suite('formatDiffForDisplay', () => {
        test('should format diff for display', () => {
            ...
            const formatted = diffProcessor_1.DiffProcessor.formatDiffForDisplay(files);
...
//# sourceMappingURL=diffProcessor.test.js.map